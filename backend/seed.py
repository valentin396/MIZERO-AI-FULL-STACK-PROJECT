...
SAMPLES = [
    ...
    dict(status="FOUND", category="Phone", title="Black iPhone found near Kimironko stalls",
         ...
         location="Gasabo", landmark="Kimironko", event_date=date(2026, 8, 30)),
    dict(status="RECOVERED", category="Bag", title="Blue backpack found at Kigali Convention Centre",
    ...
    dict(status="FOUND", category="Keys", title="Car keys found outside Amahoro Stadium",
         ...
         location="Gasabo", landmark="Remera, Amahoro Stadium", event_date=date(2026, 8, 22)),
    dict(status="RECOVERED", category="Document", title="Marriage certificate lost after Sunday service",
    ...
    dict(status="RECOVERED", category="Wallet", title="Brown leather wallet lost near Musanze taxi park",
    ...
    dict(status="RECOVERED", category="Keys", title="Bunch of house keys lost in Rubavu",
    ...
    dict(status="RECOVERED", category="Phone", title="Phone found near Nyagatare cattle market",
