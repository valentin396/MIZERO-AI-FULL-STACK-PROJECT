  ...
  if (done) {
    return (
      <div className="border border-ink/15 bg-cream p-6 text-center">
        <p className="font-medium text-hills mb-2">Report submitted ✓</p>
  ...
  return (
    <form onSubmit={handleSubmit} className="border border-ink/15 bg-cream p-5 space-y-4">
      <h2 className="text-lg font-semibold flex items-center gap-2">
        {status === 'LOST' ? '←' : '→'} Report {status === 'LOST' ? 'Lost' : 'Found'} Item
      </h2>
      ...
      <div>
        <label className="block text-xs text-ink/50 mb-1">Description</label>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          <label className="block text-xs text-ink/50 mb-1">Location</label>
      ...
      <div>
        <label className="block text-xs text-ink/50 mb-1">Upload Image</label>
